...
#dailyHostsList = dayToHostPairTuple.take(3)
print 'Unique hosts per day: %r' % dailyHostsList
...
avgDailyReqPerHost = (sortedByDay.mapValues(lambda hostlist: len(hostlist)/len(set(hostlist))).cache())
